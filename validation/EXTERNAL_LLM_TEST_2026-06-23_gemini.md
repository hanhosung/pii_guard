...
- ❌ **미검출(0)**: —
- ⚠️ **오탐후보(12)**: `PERSON`=auth, `PERSON`=auth, `HOSTNAME`=api.internal, `PERSON`=auth, `ORGANIZATION`=detected, `ORGANIZATION`=HOSTNAME, `PERSON`=auth, `ORGANIZATION`=third, `PERSON`=auth, `ORGANIZATION`=security, `ORGANIZATION`=found, `PERSON`=auth
...
- ❌ **미검출(0)**: —
- ⚠️ **오탐후보(5)**: `ORGANIZATION`=Received, `ORGANIZATION`=webhook, `ORGANIZATION`=ABC-9921, `PERSON`=active, `ORGANIZATION`=Webhook
